...
handheld-radio-popular-label = Popular frequencies
handheld-radio-custom-label = Custom frequency
handheld-radio-custom-placeholder = {$min}-{$max} kHz
handheld-radio-preset-custom = Custom
handheld-radio-preset-option = Channel {$channel} ({$frequency} kHz)
